...
export class WorkoutServiceService {
  ...
  startWorkout(id) {
    this.http.post(`${environment.API_HOST}/workout`, id).subscribe();
  }
  ...
  startExercise(
    ...
    this.http
      .put(`${environment.API_HOST}/workout/${id}`, { exerciseId, exercise })
      .subscribe(() => {
  ...
  addSet(id: string, exerciseId: string, set: Set) {
    this.http
      .put(`${environment.API_HOST}/workout/${id}/exercises/${exerciseId}`, set)
      .subscribe(() => this.retrieveSets(id, exerciseId));
  }

  retrieveSets(id: string, exerciseId: string) {
    this.http
      .get(`${environment.API_HOST}/workout/${id}/exercises/${exerciseId}`)
